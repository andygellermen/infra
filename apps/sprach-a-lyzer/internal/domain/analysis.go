...
const (
	DimensionAgency       DimensionID = "AGENCY"
	DimensionConnection   DimensionID = "CONNECTION"
	DimensionAppreciation DimensionID = "APPRECIATION"
	DimensionClarity      DimensionID = "CLARITY"
	DimensionVolition     DimensionID = "VOLITION"
	DimensionOpenness     DimensionID = "OPENNESS"
)

var Dimensions = []DimensionID{
	DimensionAgency,
	DimensionConnection,
