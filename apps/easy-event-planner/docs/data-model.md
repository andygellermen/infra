...
CREATE INDEX idx_certificates_participant_issued ON certificates(tenant_id, participant_id, issued_at DESC);
CREATE INDEX idx_certificates_event_issued ON certificates(tenant_id, event_id, issued_at DESC);
```
