...
wp_auth_key="$(openssl rand -base64 48 | tr -d '\n')"
wp_secure_auth_key="$(openssl rand -base64 48 | tr -d '\n')"
wp_logged_in_key="$(openssl rand -base64 48 | tr -d '\n')"
wp_nonce_key="$(openssl rand -base64 48 | tr -d '\n')"
wp_auth_salt="$(openssl rand -base64 48 | tr -d '\n')"
wp_secure_auth_salt="$(openssl rand -base64 48 | tr -d '\n')"
wp_logged_in_salt="$(openssl rand -base64 48 | tr -d '\n')"
wp_nonce_salt="$(openssl rand -base64 48 | tr -d '\n')"

{
  ...
  echo "wp_auth_key: \"${wp_auth_key}\""
  echo "wp_secure_auth_key: \"${wp_secure_auth_key}\""
  echo "wp_logged_in_key: \"${wp_logged_in_key}\""
  echo "wp_nonce_key: \"${wp_nonce_key}\""
  echo "wp_auth_salt: \"${wp_auth_salt}\""
  echo "wp_secure_auth_salt: \"${wp_secure_auth_salt}\""
  echo "wp_logged_in_salt: \"${wp_logged_in_salt}\""
  echo "wp_nonce_salt: \"${wp_nonce_salt}\""
  echo "wp_disable_file_edit: true"
  ...
  echo "wp_xmlrpc_protection: \"block\""
  echo "wp_xmlrpc_allowed_cidrs: []"
